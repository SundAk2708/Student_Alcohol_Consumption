...
#Final_grade_math= 10.63 + 0.359 * freetime -2.154 * failures -0.51 *gout +
0.27 * studytime + 0.09 * alcohol
...
savehistory("C:/KB/Study/Kaggle data/Students/Student_Alcohol_Consumption.Rhistory")
